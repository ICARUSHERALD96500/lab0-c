...
#define DUDECT_TESTS (1 + NUMBER_PERCENTILES)
...
{
    t_context_t *max_ctx = max_test();
    double max_t = fabs(t_compute(max_ctx));
    double number_traces_max_t = max_ctx->n[0] + max_ctx->n[1];
